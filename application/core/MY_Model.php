...
class MY_Model extends CI_Model {
	...
	//insert log aktivitas admin
	public function log_aktivitas_admin($aktivitas){
		$tabel_log = 'sbc_log_aktivitas';
		$data = array(
			'id_aktivitas'			=> NULL,
			'id_admin_aktivitas'	=> $this->session->userdata('id_admin'),
			'nama_aktivitas'		=> $this->session->userdata('nama_admin')." -> ".$aktivitas,
			'time_aktivitas'		=> mdate("%Y-%m-%d %h:%i:%s")
		);
		...
		/*if($insert){
			...
			printf("<a href='".site_url(%s)."'>Kembali ke halaman %s</a>\n\n", $link, $string);
			exit('Terjadi kesalahan dalam pencatatan log aktivitas admin.');
		}*/
	}
